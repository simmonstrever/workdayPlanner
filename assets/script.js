...
$(hour8).on("click", function(){
   ...
   $("#8").text(plan8);
   localStorage.setItem("8am plans", plan8);
});
...
$(hour9).on("click", function(){
 ...
 $(hour5).on("click", function(){
     ...
     $("#5").text(plan5);
     localStorage.setItem("5pm plans", plan5);
  });
